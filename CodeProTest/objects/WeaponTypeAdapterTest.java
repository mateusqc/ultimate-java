...
/**
 * The class <code>WeaponTypeAdapterTest</code> contains tests for the class <code>{@link WeaponTypeAdapter}</code>.
 *
...
public class WeaponTypeAdapterTest {
	...
	public void testMarshal_1()
		throws Exception {
		WeaponTypeAdapter fixture = new WeaponTypeAdapter();
	...
	public void testUnmarshal_1()
		...
		//       at objects.WeaponTypeAdapter.unmarshal(WeaponTypeAdapter.java:14)
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(WeaponTypeAdapterTest.class);
	}
}